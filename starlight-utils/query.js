...
async function main () {
  ...
  const erc20Addresses = [erc20XContractAddress, erc20YContractAddress]
  const balancesSender = parseCommitments(senderAddress, erc20Addresses, validTokenIds)(commitmentsSender)
  const balancesReceiver = parseCommitments(receiverAddress, erc20Addresses, validTokenIds)(commitmentsReceiver)
