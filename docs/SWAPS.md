...
- [ERC20 para ERC20 - `/startSwapFromErc20ToErc20`](#g-começar-um-swap-de-erc20-para-erc20---startswapfromerc20toerc20)
...
- [ERC20 para ERC20 - `/completeSwapFromErc20ToErc20`](#h-completar-um-erc20-para-erc20---completeswapfromerc20toerc20)
- [TPFt (ERC1155) para Real Digital (ERC20) - `/completeSwapFromErc1155ToErc20`](#d-completar-um-swap-tpft-erc1155-para-real-tokenizado-erc20---completeswapfromerc1155toerc20)
...
## G) Começar um Swap de ERC20 para ERC20 - `/startSwapFromErc20ToErc20`

### Rota
`POST <endereço_da_aplicação:3000>/startSwapFromErc20ToErc20`

### Descrição
Essa rota é utilizada para iniciar um swap de ERC20 para ERC20 no SwapShield.
...
| Field                | Type   | Description                                          | Required |
|----------------------|--------|------------------------------------------------------|----------|
| `erc20AddressSent`       | string | Endereço do ERC20 que será enviado          | Yes      |
| `erc20AddressReceived`       | string | Endereço do ERC20 que será recebido             | Yes      |
| `counterParty`       | string | Endereço da contraparte que receberá o swap          | Yes      |
| `amountSent`| number | Quantidade de ERC20 a ser enviado | Yes      |
| `amountReceived`         | number | Quantidade de ERC20 a ser recebido          | Yes      |
...
## H) Completar um swap de ERC20 para ERC20 - `/completeSwapFromErc20ToErc20`

### Rota
`POST <endereço_da_aplicação:3000>/completeSwapFromErc20ToErc20`

### Descrição
Essa rota é utilizada para completar um swap de ERC20 para ERC20 no SwapShield.
